...
void system_init(void)
{
	...
	gpio_set_pin_direction(EN_OUT, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(EN_OUT, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PB16

	gpio_set_pin_level(LED_DET,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
	...
	// Set pin direction to output
	gpio_set_pin_direction(LED_DET, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(LED_DET, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PB17

	gpio_set_pin_level(LED_ON,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
	...
	// Set pin direction to output
	gpio_set_pin_direction(LED_ON, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(LED_ON, GPIO_PIN_FUNCTION_OFF);
